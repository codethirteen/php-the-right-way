...
[Zend Server CE][zsce], [XAMPP][xampp], [EasyPHP][easyphp], [Bitnami WAMP stack][bitnami], and [WAMP][wamp] will help get a Windows development environment up and running fast. That said, these tools will be 
